  ...
  return (
    <footer className="footer">
      <div className="footer-links">
        ...
        <a href="mailto:contact@glprojects.help@gmail.com">Contact Us</a>
      ...
      <div className="footer-newsletter">
        <form action="/subscribe" method="post">
          <input type="email" name="email" placeholder="Subscribe to our newsletter" required autocomplete='true' />
